...
function App() {
  return (
    <div className="App">
      ...
      <header className="App-header" class="header mb-5">
        <h1>Xuan's Cooking World</h1>
          <p>From here, you can find my cooking practice and enjoy numbers of ways to make delicious meal</p>
                  ...
                  <div class="modal-body">
                    <form action="customer-orders.html" method="post">
                      <div class="form-group">
                        <input id="email-modal" type="text" placeholder="email" class="form-control"></input>
                      </div>
                      <div class="form-group">
                        <input id="password-modal" type="password" placeholder="password" class="form-control"></input>
                      </div>
                      <p class="text-center">
          ...
          <nav class="navbar navbar-expand-lg">
            <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"></img><img src="img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"></img><span class="sr-only">Obaju - go to homepage</span></a>
                    ...
                    <ul class="dropdown-menu megamenu">
                      <li>
                        <div class="row">
                          ...
                          <div class="col-md-6 col-lg-3">
                            <div class="banner"><a href="#"><img src="img/banner.jpg" alt="" class="img img-fluid"></img></a></div>
                            <div class="banner"><a href="#"><img src="img/banner2.jpg" alt="" class="img img-fluid"></img></a></div>
                          </div>
                        </div>
                      </li>
                    </ul>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div id="main-slider" class="owl-carousel owl-theme">
                    <div class="item"><img src="img/main-slider1.jpg" alt="" class="img-fluid"></img></div>
                    <div class="item"><img src="img/main-slider2.jpg" alt="" class="img-fluid"></img></div>
                    <div class="item"><img src="img/main-slider3.jpg" alt="" class="img-fluid"></img></div>
                    <div class="item"><img src="img/main-slider4.jpg" alt="" class="img-fluid"></img></div>
                  </div>
                ...
                <div class="product-slider owl-carousel owl-theme">
                  <div class="item">
                    <div class="product">
                      <div class="flip-container">
                        <div class="flipper">
                          <div class="front"><a href="detail.html"><img src="img/product1.jpg" alt="" class="img-fluid"></img></a></div>
                          <div class="back"><a href="detail.html"><img src="img/product1_2.jpg" alt="" class="img-fluid"></img></a></div>
                        </div>
                      </div><a href="detail.html" class="invisible"><img src="img/product1.jpg" alt="" class="img-fluid"></img></a>
                      <div class="text">
                  ...
                  <div class="item">
                    <div class="product">
                      <div class="flip-container">
                        <div class="flipper">
                          <div class="front"><a href="detail.html"><img src="img/product2.jpg" alt="" class="img-fluid"></img></a></div>
                          <div class="back"><a href="detail.html"><img src="img/product2_2.jpg" alt="" class="img-fluid"></img></a></div>
                        </div>
                      </div><a href="detail.html" class="invisible"><img src="img/product2.jpg" alt="" class="img-fluid"></img></a>
                      <div class="text">
                  ...
                  <div class="item">
                    <div class="product">
                      <div class="flip-container">
                        <div class="flipper">
                          <div class="front"><a href="detail.html"><img src="img/product3.jpg" alt="" class="img-fluid"></img></a></div>
                          <div class="back"><a href="detail.html"><img src="img/product3_2.jpg" alt="" class="img-fluid"></img></a></div>
                        </div>
                      </div><a href="detail.html" class="invisible"><img src="img/product3.jpg" alt="" class="img-fluid"></img></a>
                      <div class="text">
              ...
              <div class="col-md-12">
                <div class="box slideshow">
                  ...
                  <div id="get-inspired" class="owl-carousel owl-theme">
                    <div class="item"><a href="#"><img src="img/getinspired1.jpg" alt="Get inspired" class="img-fluid"></img></a></div>
                    <div class="item"><a href="#"><img src="img/getinspired2.jpg" alt="Get inspired" class="img-fluid"></img></a></div>
                    <div class="item"><a href="#"><img src="img/getinspired3.jpg" alt="Get inspired" class="img-fluid"></img></a></div>
                  </div>
                </div>
              </div>
            </div>
